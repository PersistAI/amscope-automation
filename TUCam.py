...
# Build absolute path to TUCam.dll in the same folder
dll_path = os.path.join(current_dir, r"C:\Users\ruyek\Downloads\MicroscopeImaging\lib\x64\TUCam.dll")


TUSDKdll = OleDLL(dll_path)

if TUSDKdll: 
    print("API path working")
else: 
    print("API path not working")
...
class TUCAMRET(Enum):
    ...
    TUCAMRET_UNKNOWN_ERROR = -2147482862
...
#TUCAM_Api_Config = TUSDKdll.TUCAM_Api_Config
#TUCAM_Api_Config.argtypes = [c_int32, c_int32]
#TUCAM_Api_Config.restype  = TUCAMRET
...
TUCAM_Cap_DoSoftwareTrigger.argtypes = [c_void_p, c_uint32]
...
# buffer control
TUCAM_Buf_Attach = TUSDKdll.TUCAM_Buf_Attach
TUCAM_Buf_Attach.argtypes = [c_void_p, c_void_p, c_uint32]
TUCAM_Buf_Attach.restype  = TUCAMRET
TUCAM_Buf_Detach = TUSDKdll.TUCAM_Buf_Detach
TUCAM_Buf_Detach.argtypes = [c_void_p]
TUCAM_Buf_Detach.restype  = TUCAMRET
